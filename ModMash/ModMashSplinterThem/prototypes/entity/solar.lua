...
data:extend(
{
    ...
    {
        type = "corpse",
        name = "them-solar-panel-remnants",
        icon = "__modmashsplinter__/graphics/icons/bad-icon.png",
        icon_size = 64, icon_mipmaps = 4,
        ...
        {
          filename = "__modmashsplinterthem__/graphics/entity/solar/solar-panel-remnants.png",
          line_length = 1,
          width = 146,
          height = 142,
          frame_count = 1,
          ...
          hr_version =
          {
            filename = "__modmashsplinterthem__/graphics/entity/solar/hr-solar-panel-remnants.png",
            line_length = 1,
            width = 290,
            height = 282,
            frame_count = 1,
    ...
    },
    {
        ...
        corpse = "them-solar-panel-remnants",
