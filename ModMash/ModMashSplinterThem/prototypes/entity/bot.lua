...
data:extend(
{
	-------------base
	{
        ...
        icon_size = 64, icon_mipmaps = 4,   
		map_color = {r=1.0, g=0.0, b=0.5},
		flags = {placeable,"placeable-enemy", "player-creation", "placeable-off-grid","hide-alt-info"},
		minable = minable,
	...
	-------------raid
	{
        ...
        icon_size = 64, icon_mipmaps = 4,   
		map_color = {r=1.0, g=0.0, b=0.5},
		flags = {placeable,"placeable-enemy", "player-creation", "placeable-off-grid","hide-alt-info"}, --  "not-on-map"
		minable = minable,
		resistances = resistances,
		alert_when_damaged = false,
		max_health = 25,
