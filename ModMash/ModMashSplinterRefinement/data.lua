...
require("prototypes.categories.refining")
require("prototypes.item.ore-refinery")
require("prototypes.recipe.ore-refinery")
...
menu_simulations.menu_simulation_refinement = {
    checkboard = false,
    save = "__modmashsplinterrefinement__/saves/menu-simulation-refinement.zip",
    length = 60 * 15,
    init = [[
