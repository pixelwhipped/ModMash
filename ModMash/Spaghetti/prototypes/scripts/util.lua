...
if not spaghetti.util.table then spaghetti.util.table = {} end
...
local local_get_entity_size = function(entity)
	...
	if entity.prototype.selection_box ~= nil then				
		return {
				math.floor((entity.prototype.selection_box["right_bottom"]["x"] - entity.prototype.selection_box["left_top"]["x"])+0.5),
				math.floor((entity.prototype.selection_box["right_bottom"]["y"] - entity.prototype.selection_box["left_top"]["y"])+0.5)}
	end
	--[[if entity.selection_box ~= nil then				
		return {
				math.floor((entity.selection_box["right_bottom"]["x"] - entity.selection_box["left_top"]["x"])+0.5),
				math.floor((entity.selection_box["right_bottom"]["y"] - entity.selection_box["left_top"]["y"])+0.5)}
	end]]
	return {1,1} 
end
