...
spaghetti.defines.defaults.initial_expected_entitites_in_tiles = (32*32)*0.6


--[[events]]
spaghetti.events.on_build = {defines.events.on_built_entity, defines.events.on_robot_built_entity}
spaghetti.events.on_remove = {defines.events.on_entity_died,defines.events.on_robot_pre_mined,defines.events.on_robot_mined_entity,defines.events.on_player_mined_entity}