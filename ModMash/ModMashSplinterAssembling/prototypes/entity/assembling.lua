...
if data_final_fixes then
    ...
    if settings.startup["setting-assembling-machine-burner-only"].value == "No" then
        local_add_entity(
        {
            ...
            icon_mipmaps = 4,        
		    flags = {"placeable-neutral", "placeable-player", "player-creation"},
		    minable = {mining_time = 0.2, result = "assembling-machine-f"},
		    max_health = 150,
		    corpse = "big-remnants",
		    dying_explosion = "medium-explosion",
		    resistances =
            ...
            animation =
            {
              ...
              {
                {
                  filename = "__modmashsplinterassembling__/graphics/entity/assembling-machine-f/assembling-machine-f.png",
                  priority="high",
                  width = 108,
                  height = 114,
                  frame_count = 32,
                  ...
                  hr_version =
                  {
                    filename = "__modmashsplinterassembling__/graphics/entity/assembling-machine-f/hr-assembling-machine-f.png",
                    priority="high",
                    width = 214,
                    height = 226,
                    frame_count = 32,
                ...
                {
                  filename = "__modmashsplinterassembling__/graphics/entity/assembling-machine-f/assembling-machine-1-shadow.png",
                  priority="high",
                  width = 95,
                  height = 83,
                  frame_count = 1,
                  ...
                  hr_version =
                  {
                    filename = "__modmashsplinterassembling__/graphics/entity/assembling-machine-f/hr-assembling-machine-1-shadow.png",
                    priority="high",
                    width = 190,
                    height = 165,
                    frame_count = 1,
