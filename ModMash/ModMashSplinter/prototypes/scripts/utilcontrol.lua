...
modmashsplinter.fluid.transfer_fluid = local_transfer_fluid
modmashsplinter.fluid.transfer_fluid_and_convert = local_transfer_fluid_and_convert
modmashsplinter.fluid.get_connected_input_fluid = local_get_connected_input_fluid
modmashsplinter.fluid.change_fluidbox_fluid = local_change_fluidbox_fluid
modmashsplinter.fluid.clear_fluid_recipe = local_clear_fluid_recipe
